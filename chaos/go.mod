module github.com/dwsmith1983/interlock-chaos

go 1.25.6

replace github.com/dwsmith1983/chaos-data => ../../chaos-data
...
require (
	...
	github.com/dwsmith1983/chaos-data v0.0.0-00010101000000-000000000000
